    ...
    <Layout>
      ...
      <main className={styles.book_main}>
        ...
        <div className={styles.actions}>
          <a className="button_redirection" target="_blank" rel="nofollow" href={bookData.read}>
            <button>
          ...
          <a className="button_redirection" target="_blank" rel="nofollow" href={bookData.download} download>
            <button>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
